...
public class GameSaveData implements Serializable {
    ...
    public Map<CropType, Integer> getCropStorage() { return cropStorage; }
    public Map<AnimalType, Integer> getAnimalStorage() { return animalStorage; }
    public Map<CropType, Integer> getFeedStorage() { return feedStorage; }
    public Map<Resource, Integer> getResourceStorage() { return resourceStorage; }
    public ArrayList<Finance.Transaction> getTransactions() { return transactions; }
}